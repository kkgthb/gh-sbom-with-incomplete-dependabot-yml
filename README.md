Hypothesis:  If I include a manual `dependabot.yml` file and thereby disable auto-submission, and if I include a mix of coding languages, all of which are eligible to be SBOM-scanned by GitHub's Dependabot and even normally would auto-submit, theoretically, because of my manual override that forgot one of the languages, a language ends up failing to appear in the SBOM.
